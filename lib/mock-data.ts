...
// --- Moderator Business Deactivation Requests ---

export const mockDeactivationRequests: BusinessDeactivationRequest[] = [
  {
    id: 'deact-1',
    business_id: 'biz-8',
    business_name: 'Vivid Design Hub',
    business_slug: 'vivid-design-hub',
    business_category: 'Creative Services',
    business_location: 'Nairobi, Kenya',
    owner_name: 'Rtr. Alisha Fernandez',
    moderator_id: 'user-2',
    moderator_name: 'Ptr. Dilshan Wickremasinghe',
    district_number: 3220,
    reason_category: 'inactivity',
    reason_details: 'The business listing has had disconnected contact numbers and bounce-back email responses during the district annual directory audit. No response to 3 compliance notices sent over the last 90 days.',
    evidence_notes: 'Returned audit logs attached from June and July 2026 verification rounds.',
    urgency: 'medium',
    status: 'pending',
  ...
  },
  {
    id: 'deact-2',
    business_id: 'biz-p2',
    business_name: 'Green Earth Designs',
    business_slug: 'green-earth-designs',
    business_category: 'Real Estate & Construction',
    business_location: 'Colombo, Sri Lanka',
    owner_name: 'Rtr. Arjun Mehta',
    moderator_id: 'user-2',
    moderator_name: 'Ptr. Dilshan Wickremasinghe',
    district_number: 3220,
    reason_category: 'fraudulent_info',
    reason_details: 'Submitted invalid Rotary club membership ID and non-existent BRN registration during district physical spot check.',
    evidence_notes: 'Discrepancy confirmed by Rotary Club of Colombo Secretariat on Aug 10, 2026.',
    urgency: 'critical',
    status: 'pending',
  ...
  },
  {
    id: 'deact-3',
    business_id: 'biz-4',
    business_name: 'Vanguard Legal',
    business_slug: 'vanguard-legal',
    business_category: 'Professional Services',
    business_location: 'Lagos, Nigeria',
    owner_name: 'Rtr. Zainab Abiola',
    moderator_id: 'user-7',
    moderator_name: 'Rtr. Ayodeji Balogun',
    district_number: 9110,
    reason_category: 'ceased_operations',
    reason_details: 'Firm has formally merged into a multinational entity and requested deregistration under individual Rotaract banner.',
    urgency: 'low',
    status: 'approved',
    admin_notes: 'Verified dissolution memo. Deactivated from public directory.',
    reviewed_by: 'Rtn. Kanishka De Silva',
  ...
  },
  {
    ...
    business_slug: 'studio-bloom',
    business_category: 'Creative Services',
    business_location: 'Colombo, Sri Lanka',
    owner_name: 'Rtr. Marcus Vance',
    moderator_id: 'user-2',
    moderator_name: 'Ptr. Dilshan Wickremasinghe',
    district_number: 3220,
    reason_category: 'unresponsive',
    reason_details: 'Owner did not provide updated DRR endorsement for new tenure.',
    urgency: 'low',
    status: 'rejected',
    admin_notes: 'Owner contacted District Secretariat directly and provided the renewal document on Aug 12.',
    reviewed_by: 'Rtn. Kanishka De Silva',
    reviewed_at: '2026-08-13T16:20:00Z',
